      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] bg-brand px-6 py-16 text-center sm:px-16 sm:py-20">
            ...
            <a
              href="#avions"
              className="relative mt-8 inline-block rounded-full bg-white px-8 py-4 font-semibold text-brand shadow-lg shadow-brand-900/30 transition hover:-translate-y-0.5 hover:bg-brand-50"
            >
              Choisir un avion
            </a>
          </div>
